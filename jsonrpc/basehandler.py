...
class BaseHandler(webapp2.RequestHandler):
    ...
    def dispatch(self):
        ...
        # The rate limiting allows you to not serve more request that might be an autogenerated request
    ...
    def _rate_limiter(self):
        ...
        # The reason we use 503 is because webapp2 does not have 429 code in it's supported codes because it's not official status code yet
